...
Axes::Axes (float scale)
{
  // First we initialize the shader for drawing the axes
	std::cout << "Starting axes" << std::endl;
	/*
    if (InitShader()) {
    ...
    */
    ...
    cs237::color3f	colors[6] = {
	    cs237::color3f(1, 0, 0), cs237::color3f(1, 0, 0), // red -> X
	    cs237::color3f(0, 1, 0), cs237::color3f(0, 1, 0), // green -> Y
	    cs237::color3f(0.1, 0.1, 1), cs237::color3f(0.1, 0.1, 1), // blue -> Z
	};
